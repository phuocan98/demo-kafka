...
namespace Project.Modules.UploadFiles.Services
{
    public interface IUploadFileService
    {
        Task<(bool check, string fullPath, object data)> Upload(IFormFile file, string path);
    ...
    public class UploadFileService : IUploadFileService
    {
        ...
        public async Task<(bool check, string fullPath, object data)> Upload(IFormFile file, string path)
        {
            try
            {
